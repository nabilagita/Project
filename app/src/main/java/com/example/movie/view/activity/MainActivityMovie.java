...
import com.example.movie.view.fragment.ProfilFragment;
import com.example.movie.view.fragment.UpcomingFragment;
import com.google.android.material.bottomnavigation.BottomNavigationView;

public class MainActivityMovie extends AppCompatActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            ...
            case R.id.menu_bottomnav_profil:
